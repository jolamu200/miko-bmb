...
const styles = tv({
    slots: {
        ...
        icon: "absolute left-3.5 top-1/2 -translate-y-1/2 z-10 size-5 text-muted pointer-events-none transition-colors duration-300 group-focus-within:text-accent",
    },
    variants: {
        hasIcon: {
            true: { input: "pl-11" },
